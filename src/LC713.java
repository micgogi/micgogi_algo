...
public class LC713 {
    public static void main(String[] args) {
        ...
        System.out.println(numSubArrayPrduct(a,k));
    }


    public static int numSubArrayPrduct(int a[], int k){
        if(k<=1)return 0;
